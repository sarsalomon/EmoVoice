...
const Registration = () => {
    ...
    const registrationUser = async() => {
        ...
        try {
            await axios.post("http://localhost:5000/api/auth/registration", newUser)
                        ...
                        <div>
                            <div className='my-2'>
                                ...
                                <div className='form-input-registration my-1'>
                                    <input value={email} onChange={e => setEmail(e.target.value)} className='form-input-regis' type="email" placeholder='name@gmail.com' name="" id="email" />
                            ...
                            <div className='my-4'>
                                ...
                                <div className='form-input-registration my-1'>
                                    <input value={password} onChange={e => setPassword(e.target.value)} className='form-input-regis' type="password" placeholder='password' name="" id="password" />
                            ...
                            <button style={{
                                fontSize: "22px",
                                fontWeight: "600"
                            }} onClick={registrationUser} className='w-100 btn btn-primary py-2 shadow-none'>Create accaunt</button>
                        </div>
